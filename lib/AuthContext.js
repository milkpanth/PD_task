...
export const ROLE_CONFIG = {
  'Super Admin': { canDelete: true, canAccessAdmin: true, canAccessPD: true, canAccessOverall: true, canViewLogs: true, projectScope: 'all' },
  'CTO': { canDelete: false, canAccessAdmin: true, canAccessPD: true, canAccessOverall: true, canViewLogs: false, projectScope: 'all' },
  'PD Manager': { canDelete: false, canAccessAdmin: true, canAccessPD: true, canAccessOverall: true, canViewLogs: false, projectScope: 'all' },
  'PD Team': { canDelete: false, canAccessAdmin: true, canAccessPD: true, canAccessOverall: true, canViewLogs: false, projectScope: 'all' },
  'SD': { canDelete: false, canAccessAdmin: false, canAccessPD: false, canAccessOverall: false, canViewLogs: false, projectScope: 'assigned' },
  'SD Manager': { canDelete: false, canAccessAdmin: false, canAccessPD: false, canAccessOverall: true, canViewLogs: false, projectScope: 'all' },
  'QA': { canDelete: false, canAccessAdmin: false, canAccessPD: false, canAccessOverall: false, canViewLogs: false, projectScope: 'assigned' },
  'QA Manager': { canDelete: false, canAccessAdmin: false, canAccessPD: false, canAccessOverall: true, canViewLogs: false, projectScope: 'all' },
};

const NO_ROLE_PERMS = { canDelete: false, canAccessAdmin: false, canAccessPD: false, canAccessOverall: false, canViewLogs: false, projectScope: 'assigned' };
